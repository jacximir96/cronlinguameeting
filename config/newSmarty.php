<?php
	...
	class newSmarty extends Smarty
	{
		public function __construct($PPlantilla='views') 
		{
			...
			$nombre_directorio_temporal='TmpLinguameeting/';
			...
			$this->compile_dir 		= $DirBase.'/lib/smarty/smarty/'.$nombre_directorio_temporal.$PPlantilla.'/';
			$this->config_dir 		= $DirBase.'/lib/smarty/smarty/'.'configs/';
			$this->cache_dir 		= $DirBase.'/lib/smarty/smarty/'.'cache/';	
