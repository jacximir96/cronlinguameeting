 ...
 */
class courseDocumentationModel extends baseModel {
	...
	parent::__construct();
	parent::setTable('lm_course_documentation');
    }
	...
	$where = 'id_section=' . $this->id_section . ' AND id_week=' . $this->id_week;
	$first = true;
