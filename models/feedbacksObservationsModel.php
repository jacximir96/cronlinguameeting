...
/**
 * Description of feedbacksObservationsModel
 *
 * @author Sandra
 */
class feedbacksObservationsModel extends baseModel{
     //put your code here

    private $id_feed_obs = 0;
	...
	parent::__construct();
	parent::setTable('lm_feedbacks_observations');
    }
	...
	$where = 'id_feed_obs=' . $this->id_feed_obs;
	$first = true;
    ...
    function getId_feed_obs() {
	return $this->id_feed_obs;
    }
    ...
    function setId_feed_obs($id_feed_obs) {
	$this->id_feed_obs = $id_feed_obs;
    }
