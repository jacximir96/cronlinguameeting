...
class coursesSectionModel extends baseModel {
	...
	function __construct() {
		...
		parent::__construct();
		parent::setTable('lm_courses_sections');
	}
	...
	public function update($campos='', $where = '') {
		...
		if ($first) {
			$campos .= " heritage_section=$this->heritage_section,is_Flex=$this->is_Flex,free_section=$this->free_section,inst_coaches";
			$first = false;
		} else {
